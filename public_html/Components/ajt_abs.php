                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4 row">
                                <select name="mataire" style="width:150px" class="form-control m-1" id="classNTRX">
                                    <option value="">Select Mataire</option>
                                    <?php
                                    $res2 = $conn->query($epost);
                                    while ($row_res2 = mysqli_fetch_assoc($res2)) {
                                        echo "<option value=" . $row_res2['id_cat'] . ">" . $row_res2['name_cat'] . "</option>";
                                    }
                                    ?>
                                </select>
                                <button type="submit" name="add_abs" class="btn btn-primary col-2 ">add abs</button>
                            </div>
                        </div>
                    </div>
